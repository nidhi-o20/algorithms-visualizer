...
const buildDoublyLinkedList = () => {
  ...
  for (let matrixRow = 0; matrixRow < totalRows; matrixRow++) {
    ...
    let node1 = new LinkedListNode(
      null,
      null,
      null,
      null,
      topColumns[node1Index],
      matrixRow
    );

    let node2 = new LinkedListNode(
      null,
      null,
      node1,
      null,
      topColumns[node2Index],
      matrixRow
    );

    let node3 = new LinkedListNode(
      null,
      null,
      node2,
      null,
      topColumns[node3Index],
      matrixRow
    );

    let node4 = new LinkedListNode(
      null,
      null,
      node3,
      null,
      topColumns[node4Index],
      matrixRow
    );
